...
| 船身 | **船的大小隨在編船員數變化**：1 桅小艇 → 5 桅旗艦。船員越多，甲板越寬、桅帆越多、砲門越多、場景越高 |
| 甲板 | 所有船員站同一塊甲板；姿勢由狀態驅動；交接物在人之間飛行 |
| 決策台 | 大決策卡：選項、before/after 圖解、PR 連結、design.md 連結、下令按鈕 |
...
船體、桅杆、船員、名牌全部對齊同一條 `--deckY` 甲板線。
人變多時船員自動縮小並重新分布，名牌依密度降級（≤6 全欄位 / 7–10 去掉任務標題 / ≥11 只留短代號與進度條），
任何人數下名牌都不得重疊。
